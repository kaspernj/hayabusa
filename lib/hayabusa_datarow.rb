...
#  user = ob.get(:User, 1) #=> <Models::User> that extends <Hayabusa::Datarow>
class Hayabusa::Datarow
  @@refs = {}
  ...
  #===Examples
  #  time_str = dbrow[:date]
  #  print "No valid date on the row." if Hayabusa::Datarow.is_nullstamp?(time_str)
